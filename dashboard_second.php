...
<body>
    ...
    <div class="siderbar">
        ...
        <ul>
            ...
            <li><a href="./php/subir_archivo.php"><i class="fas fa-share-alt"></i>Compartir un trabajo</a></li>
            <li><a href="./Calendario/index.html"><i class="fas fa-calendar-week"></i>Calendario</a></li>
    ...
    <section>
        ...
        */
        ...
        <ul>
        <li><a href="./dashboard_second.php"><?php
                print" ".$nombre." ".$apellidos;
            ?></a><a href="./php/entrega.php">Entregar a jefe</a></li>
        </ul>
        </div>
    </section>
    <!--CIRCULOS-->
...
<br>
    ...
    <div class="area-tareas">
      <?php
       $result2 = mysqli_query($conexion, "SELECT * FROM archivos WHERE destinatario='$email'");
      ...
      if (isset($titulo)||isset($destinatario)||isset($descripcion)||isset($size)||isset($ruta)) {
        ...
        echo "<p class='para'>Para: ".$para."</p>";
        echo "<p class='descripcion'>Descripcion:".$descripcion."</p>";
        echo "<p class='tamaño'>Tam ->".$size."</p>";
        ?>
        <a class="descarga" href='./archivos/<?php echo $ruta; ?>' target="_black"><i class="fas fa-download"><?php echo $ruta; ?></i></a>

        <a class="delete" href="./php/borranota.php?idnota='<?php echo $ID;?>'"><i class="far fa-trash-alt"></i> Eliminar nota </a>
        <?php echo "</div>";
      }else{
        echo "<h1>No tienes tareas pendientes</h1>";
      }
    }
       ?>
